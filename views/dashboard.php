...
if (!isset($_SESSION['usuario_id'])) {
    ...
    // normalizar rol para modales y vistas
    ...
    // consulta de prestamos activos del cliente
...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <?php if ($usuario_rol === 'ADMINISTRADOR') { ?>
                ...
                <article class="tile" id="btnReportes">
                ...
                <article class="tile" id="btnHistorial">
                    <div class="tile-icon full-reset"><i class="zmdi zmdi-calendar"></i></div>
    ...
    <script src="../js/historialDinamico.js"></script>
